    ...
    <section class="agenda-seccion" id="agenda-cita">
        ...
        <div class="agenda-contenido">
            ...
            <div class="agenda-calendario">
                <div class="calendario-input" onclick="toggleCalendario()">
                    <label>Fecha</label>
                    <div class="fecha-input">
                        <span id="fecha-mostrada">Seleccionar fecha</span>
                        <img src="https://img.icons8.com/ios/20/000000/calendar.png" alt="Calendario">
                    </div>
                    <small>MM/DD/YYYY</small>
                </div>
                <div class="calendario-caja" id="calendario-caja">
                    <div class="calendario-nav">
                        <button onclick="cambiarMes(-1)">&lt;</button>
                        <span id="mes-actual">Ago</span>
                        <button onclick="cambiarMes(1)">&gt;</button>
                        <button onclick="cambiarAnio(-1)">&lt;</button>
                        <span id="anio-actual">2025</span>
                        <button onclick="cambiarAnio(1)">&gt;</button>
                    </div>
                    ...
                    <div class="calendario-dias" id="calendario-dias">
                        <!-- Los dias se generan con JavaScript -->
                    </div>
                    <div class="calendario-acciones">
                        <button class="btn-cancelar" onclick="cerrarCalendario()">Cancel</button>
                        <button class="btn-ok" onclick="confirmarFecha()">OK</button>
                    </div>
                </div>
            </div>
