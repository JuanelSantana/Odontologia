...
<body>
    ...
    <aside class="sidebar">
        ...
        <div class="cerrar">
            <form action="{{ route('usuario.logout') }}" method="POST">
                @csrf
                <button type="submit"
                    style="background:none; border:none; color:white; cursor:pointer; font-size: 1rem; padding: 10px 20px; width: 100%; text-align: left;">Cerrar
                    Sesión</button>
            </form>
        </div>
    </aside>
    ...
    <main class="main"
        style="margin-left: 280px; width: calc(100% - 280px); position: relative; min-height: 100vh; background: #f8f9fa;">
    ...
    ">
        ...
        <div class="content" style="padding: 30px; padding-top: 90px !important;">
            ...
            <section class="stats-grid"
                ...
                <div class="stat-card"
                    style="background: white; padding: 25px; border-radius: 15px; box-shadow: 0 5px 20px rgba(0,0,0,0.05); border-left: 6px solid #00b894; display: flex; align-items: center; gap: 20px;">
                    <div
